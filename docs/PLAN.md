...
| **M5** 多设备/产品化 | 🔄 部分完成 | 多设备同步基础版、本地帖子全文搜索、应用内通知中心、中英文界面切换、头像、后台运行/托盘、公共频道 host 发布、任意成员邀请加入机制、好友目录递归查找、公开内容分发架构（outbox）、Relay 接入、频道 ToxID 邀请/一键粘贴、添加好友弹窗、打包配置已实现；实际构建安装包待做 |
