...
47. ✅ 频道页改为 QQ 式两栏布局：左侧竖排频道列表 + 创建/加入按钮，右侧聊天窗口；公共频道收进左侧折叠区
48. ✅ 性能优化：消息/日志数量上限，避免长时间运行卡顿
49. ✅ v0.2.18 发布：Windows MSI/NSIS 安装包已构建并上传 GitHub Release
50. ✅ 修复卡顿/未响应根因：c-toxcore FFI 多线程并发调用改为全局串行锁；事件泵不再长时间占锁；bootstrap 分批释放锁
51. ✅ v0.2.19 发布：Windows MSI/NSIS 安装包已构建并上传 GitHub Release
